...
class Standard extends KeyValue
{
    ...
    protected $rateLimit = '/(Quota Exceeded|exceeded the maximum allowable|exceeded your query limit|restricted due to excessive queries)|WHOIS LIMIT EXCEEDED|due to query limit controls|You have exceeded you allotted number of|Maximum Daily connection limit reached.|Too many queries from your IP/i';
